...
export const DEFAULTS = {
  AH_FLIP_MIN_PROFIT:    100_000,    // Lowered: Sniper finds smaller but safer flips
  AH_FLIP_MIN_MARGIN:    5,          // Lowered: 5% below median is already a flip (Sniper Median)
  AH_FLIP_MAX_PAGES:     10,         // Scan ALL pages (Coflnet scans entire AH)
  AH_FLIP_INTERVAL:      30,         // 30s between scans
  AH_FLIP_MAX_PER_CYCLE: 5,
  AH_FLIP_MIN_DEMAND:    0,          // Don't filter by demand (Sniper finds good items regardless)
  AH_FLIP_MIN_SAMPLES:   2,          // Need only 2 samples for lowestBin + secondLowestBin
